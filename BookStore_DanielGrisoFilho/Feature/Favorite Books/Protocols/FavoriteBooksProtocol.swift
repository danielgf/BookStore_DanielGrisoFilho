...
protocol FavoriteBooksViewModelType: AnyObject {
    var viewDelegate: FavoriteBooksViewModelViewDelegate? { get set }
    /// Data Source
...
protocol FavoriteBooksViewModelViewDelegate: AnyObject {
    func updateScreen()
}
...
protocol FavoriteBooksViewModelCoordinatorDelegate: AnyObject {
    ...
    ///   - controller: Need to receive the viewController
    func didSelectClose(from viewModel: FavoriteBooksViewModel,
                        from controller: UIViewController)
}
